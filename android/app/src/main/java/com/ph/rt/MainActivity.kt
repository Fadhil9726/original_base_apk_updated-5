...
class MainActivity : AppCompatActivity() {
    ...
    private val screenCaptureReceiver = object : BroadcastReceiver() {
        override fun onReceive(ctx: Context, intent: Intent) {
            if (intent.action == "com.ph.rt.REQUEST_SCREEN_CAPTURE") {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val screenFilter = IntentFilter("com.ph.rt.REQUEST_SCREEN_CAPTURE")
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.TIRAMISU) {
    ...
    private fun stopLockMode() {
        ...
        val i = Intent("com.ph.rt.UNLOCK").apply { setPackage(packageName) }
        sendBroadcast(i)
    }
